...
*/
                xinz.sendButLocation(from, menu(xinz, prefix, pushname, ucapanWaktu, sender, isOwner, isPremium, gcount, glimit, baterai, limit, balance, getLimit, getBalance, cekGLimit, _cmd), 'Thanks To\n- Xinz Team\n- Arasya\n- Xyann\n- Takim\n- Lolhuman\n- Xteam', fs.readFileSync('./media/saskeh.jpg'), [ { buttonId: `${prefix}sc`, buttonText: { displayText: "Source Code" }, type: 1}, { buttonId: `${prefix}owner`, buttonText: { displayText: "Owner" }, type: 1}], { contextInfo: { mentionedJid: [sender, ownerNumber, ghoo] }})
                addCountCmd('#help', sender, _cmd)
            }
                break
            case prefix+'>':
     ...
     xinz.sendButLocation(from, amjwing, `GhosKyyy `,fs.readFileSync('./media/wangsaff.jpg'), [ { buttonId: `${prefix}owner`, buttonText: { displayText: "Owner" }, type: 1}, { buttonId: `${prefix}partner`, buttonText: { displayText: "Partner" }, type: 1}],{quoted: xenz})
            ...
            case prefix+'partner':
                 ...
                 let listown = [
                                 ...
                                 { "nama": "Arasya", "nomor": "6281319944917" },
                                 { "nama": "Hazn", "nomor": "6281539336834" },
                                 { "nama" : "Takim",
                                 "nomor": "6282194424412" },
                                 { "nama": "Mark WangsAff / Pemilik WangsAff", "nomor": "0" }
                                 ]
                  let arry = []
...
//------------------< Owner >-------------------
            ...
            case prefix+'bc': case prefix+'broadcast':
                ...
                if (isImage || isQuotedImage) {
                    ...
                    let media = await xinz.downloadMediaMessage(encmedia)
                    for (let i of chiit){
                        xinz.sendMessage(i.jid, media, video, { quoted: xenz, caption: cpt })
                    }
                    replyDeface(`Sukses`)
                } else {
                    for (let i of chiit){
