...
let { ownerNumber, limitCount,
    lolkey, igbkey, xteamkey, gamewaktu,
} = setting
...
const readmore = more.repeat(4001)
        ...
        async function replyDeface(teks) {
            return xinz.sendMessage(from, teks, text, {quoted: msg, contextInfo: {mentionedJid: parseMention(teks), externalAdReply: { title: `GhosKyy Bid V2.0`, body: `Bot WhatsApp`, mediaType: 2, thumbnail: fs.readFileSync('./media/Chitanda.jpg'), sourceUrl: `https://wa.me/qr/3JPERPUV32QOJ1`}}})
        }
        ...
        async function sendButtonImage(from, query, id1, capt, quoted, options) {
             ...
             return xinz.sendMessage(from, buttonMessage2, buttonsMessage, { quoted, ...options })
        }
        ...
        const bugtroli = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {orderMessage: {itemCount: 9999999, status: 1, surface: 1, message: 'Author Xyann', orderTitle: 'gopudd', sellerJid: "0@s.whatsapp.net"}}}
        ...
        if (isVideo || isQuotedVideo) {
         if (chats.toLowerCase().includes('sticker') || chats.toLowerCase().includes('stiker')) {
          if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
           ...
           if (seconds > 10) return reply(`Maximal video 10 detik!`)
            addCountCmd('#sticker', sender, _cmd)
...
*/
                xinz.sendButLocation(from, menu(xinz, prefix, pushname, ucapanWaktu, sender, isOwner, isPremium, gcount, glimit, baterai, limit, balance, getLimit, getBalance, cekGLimit, _cmd), 'Bot Ini Masih Tahap Pengembangan, Jika Menemukan Semacam Bug Harap Lapor Owner', fs.readFileSync('./media/saskeh.jpg'), [ { buttonId: `${prefix}sc`, buttonText: { displayText: "Source Code" }, type: 1}, { buttonId: `${prefix}owner`, buttonText: { displayText: "Owner" }, type: 1}], { contextInfo: { mentionedJid: [sender, ownerNumber, ghoo] }})
                addCountCmd('#help', sender, _cmd)
            }
                break
            case prefix+'>':
...
//------------------< Sticker / Tools >-------------------
                ...
                if (isImage || isQuotedImage) {
                   addCountCmd('#sticker', sender, _cmd)
                    ...
                    await ffmpeg(`${media}`)
							...
							.toFormat('webp')
							.save(`./sticker/${sender}.webp`)
                } else if ((isVideo && msg.message.videoMessage.seconds < 11 || isQuotedVideo && msg.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.seconds < 11)) {
                    addCountCmd('#sticker', sender, _cmd)
                ...
                if (isImage || isQuotedImage) {
                   addCountCmd('#stickerwm', sender, _cmd)
                    ...
                    await ffmpeg(`${media}`)
							...
							.toFormat('webp')
							.save(`./sticker/${sender}.webp`)
                } else if ((isVideo && msg.message.videoMessage.fileLength < 11000000 || isQuotedVideo && msg.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.fileLength < 11000000)) {
                    addCountCmd('#stickerwm', sender, _cmd)
                    let encmedia = isQuotedVideo ? JSON.parse(JSON.stringify(msg).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : msg
                    let media = await xinz.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
					exif.create(packname1, author1, `stickwm_${sender}`)
            ...
            case prefix+'tomedia':{
                ...
                if (quotedMsg.stickerMessage.isAnimated === true) {
                    ...
                    xinz.sendMessage(from, { url: res.result }, video, {quoted: msg, caption: `_*Sukses Convert Sticker To Video*_\n*• Processed :* ${processTime(now, moment())} _detik_`})
                    fs.unlinkSync(media)
                    limitAdd(sender, limit)
                } else {
                    ...
                    xinz.sendMessage(from, fs.readFileSync(ran), image, {thumbnail: Buffer.alloc(0), quoted: msg, caption: `_*Sukses Convert Sticker To Image*_\n*• Processed :* ${processTime(now, moment())} _detik_`})
                    limitAdd(sender,  limit)
                    fs.unlinkSync(ran)
                    })
                  }
        ...
        break;
            ...
            case prefix+'semoji':{
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/semoji${o}.webp -o ./sticker/semoji${o}.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    xinz.sendMessage(from, fs.readFileSync(`./sticker/semoji${o}.webp`), sticker, {quoted: msg})
                    limitAdd(sender, limit)
           ...
           case prefix+'bucinstik': case prefix+'stikerbucin':{
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/bucin${y}.webp -o ./sticker/bucin${y}.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    xinz.sendMessage(from, fs.readFileSync(`./sticker/bucin${y}.webp`), sticker, {quoted: msg})
                    limitAdd(sender, limit)
...
case prefix+'ktp': case prefix+'ktp':
           ...
           case prefix+'corona': case prefix+'covid': case prefix+'covid19': case prefix+'covid-19':{
            ...
            case prefix+'ssweb': case prefix+'screenshotweb':{
                 ...
                 reply(mess.wait)
                 var web = `https://api.lolhuman.xyz/api/ssweb?apikey=${lolkey}&url=${isUrl(args[1])[0]}`
            ...
            case prefix+'tts': case prefix+'gtts':{
                ...
                if (err) return reply('Gagal om:(')
                    xinz.sendMessage(from, buffer, audio, { quoted: msg, ptt: true, mimetype: 'audio/mp4' })
                    limitAdd(sender, limit)
                    fs.unlinkSync(rano)
                    })
                 })
            ...
            case prefix+'say':{
                ...
                getBuffer(`http://texttospeech.responsivevoice.org/v1/text:synthesize?text=${teks}&lang=${lang}&engine=g3&name=&pitch=0.5&rate=0.420&volume=1&key=0POmS5Y2&gender=${gen}`)
                 .then(async(buf) => {
                  xinz.sendMessage(from, buf, audio, { quoted: msg, mimetype: 'audio/mp4', ptt: true })
                  limitAdd(sender, limit)
                 })
            }
                break
...
//------------------< INFO >-------------------
			...
			case prefix+'pemilik': case prefix+'pemilikbot':
                xinz.sendContact(from, ownerNumber.split("@")[0], 'Xyann', 'Instagram : iamghosky_', { quoted: msg })
                .then((res) => xinz.sendMessage(from, 'This Is Contact My Owner', text, {quoted: res}))
           ...
           ngntd = '_COMING SOON_'
     xinz.sendMessage(from, ngntd,{ "orderMessage": { "itemCount": 2022, "message": `apa kak`, "footerText": "hehe", "thumbnail": fs.readFileSync('./media/saskeh.jpg'), "surface": 'CATALOG',quoted: bugtroli}})
                  break
            break
            case prefix+'partner':
                ...
                try {
                    ...
                    .then((res) => {
                        ...
                        const captionsYtmp4 = `*YOUTUBE DOWNLOAD MP4*\n\n≻ *Title :* ${title}\n≻ *Size :* ${filesizeF}\n≻ *Ext :* MP4\n\n_wait a minute, sending video..._`
                            xinz.sendMessage(from, { url: thumb }, image, { caption: captionsYtmp4, thumbnail: Buffer.alloc(0), quoted: msg })
                ...
                try {
                    ...
                    .then((res) => {
                        ...
                        const captions = `*YOUTUBE DOWNLOAD MP3*\n\n≻ *Title :* ${title}\n≻ *Size :* ${filesizeF}\n≻ *Ext :* MP3\n\n_wait a minute, sending audio..._`
                            ...
                            xinz.sendMessage(from, { url: dl_link }, document, { quoted: msg, mimetype: 'audio/mp3', filename: title+'.mp3' })
                            limitAdd(sender, limit)
                        })
                    })
                    .catch((err) => reply(`${err}`))
...
Untuk Mengambil Video/Music\n`
	...
	case prefix+'tiktoknowm': case prefix+'tiktokmp3':{
                ...
                if (args.length < 2) return xinz.sendMessage(from, teks, text, {quoted: msg, contextInfo: {externalAdReply: { title: `Tiktok Downloader`, body: `How to Use the Tiktok Download Feature`, mediaType: 2, thumbnail: fs.readFileSync('./media/Chitanda.jpg'), sourceUrl: `https://wa.me/qr/3JPERPUV32QOJ1`}}})
                if (args[1].endsWith('--help')) return xinz.sendMessage(from, teks2, text, {quoted: msg, contextInfo: {externalAdReply: { title: `Tiktok Downloader`, body: `How to Use the Tiktok Download Feature`, mediaType: 2, thumbnail: fs.readFileSync('./media/Chitanda.jpg'), sourceUrl: `https://wa.me/qr/3JPERPUV32QOJ1`}}})
                if (!isUrl(args[1])) return reply(mess.error.Iv)
	    ...
	    case prefix+'shinobu':{
			...
			case prefix+'hentai':
			    ...
			    if (isPremium) {
				 ...
				 if (!popo) return reply(`Fitur ahegao sedang di nonaktifkan oleh owner!`)
				  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply(`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				  reply(mess.wait)
				  addCountCmd('#ahegao', sender, _cmd)
				  let oa = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/ahegao?apikey=${lolkey}`)
				  xinz.sendMessage(from, oa, image, { quoted: bugtroli, caption: `Nihkak ${pushname}` })
				  limitAdd(sender, limit)
				}
			    break
        ...
        break;
            ...
            case prefix+'suit': case prefix+'suitgame': case prefix+'suitgames':{
                 ...
                 await suitJs(pilihan, sender, balance)
                   .then( res => {
                    xinz.sendMessage(from, res, text, {quoted: msg, contextInfo: {mentionedJid: parseMention(res), externalAdReply: { title: `Suit Games`, body: `GhosKyy Bid V2.0`, mediaType: 2, thumbnail: fs.readFileSync('./media/Chitanda.jpg'), sourceUrl: `https://wa.me/qr/3JPERPUV32QOJ1`}}})
                     gameAdd(sender, glimit)
                   })
            }
                 break
...
//------------------< Owner >-------------------
            ...
            case prefix+'bc': case prefix+'broadcast':
                ...
                if (isImage || isQuotedImage) {
                    ...
                    let media = await xinz.downloadMediaMessage(encmedia)
                    for (let i of chiit){
                        xinz.sendMessage(i.jid, media, image, { caption: cpt })
                    }
                    replyDeface(`Sukses`)
                } else if (isVideo || isQuotedVideo) {
                    let encmedia = isQuotedVideo ? JSON.parse(JSON.stringify(msg).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : msg
                    let media = await xinz.downloadMediaMessage(encmedia)
                    for (let i of chiit){
                        xinz.sendMessage(i.jid, media, video, { caption: cpt })
                    }
                    replyDeface(`Sukses`)
                } else {
                    for (let i of chiit){
                        xinz.sendMessage(i.jid, cpt, text)
                    }
                    replyDeface(`Sukses`)
                }
                break
...
//------------------< Enable / Disable >-------------------
            ...
            case prefix+'setwelcome': case prefix+'setwelkom':
                 ...
                 if (args[1] === '--help') {
                    ...
                    xinz.sendMessage(from, teksw, text, {quoted: msg, contextInfo: {externalAdReply: { title: `Set Welcome`, body: `How to Use the Change Welcome Text Feature`, mediaType: 2, thumbnail: fs.readFileSync('./media/Chitanda.jpg'), sourceUrl: `https://wa.me/qr/3JPERPUV32QOJ1`}}})
                 } else {
                    addCountCmd('#setwelcome', sender, _cmd)
            ...
            case prefix+'setleft': case prefix+'setout':
                 ...
                 if (args[1] === '--help') {
                    ...
                    xinz.sendMessage(from, teksl, text, {quoted: msg, contextInfo: {externalAdReply: { title: `Set Left`, body: `How to Use the Change Left Text Feature`, mediaType: 2, thumbnail: fs.readFileSync('./media/Chitanda.jpg'), sourceUrl: `https://wa.me/qr/3JPERPUV32QOJ1`}}})
                 } else {
                    addCountCmd('#setleft', sender, _cmd)
