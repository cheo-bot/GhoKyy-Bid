...
const ses = JSON.parse(fs.readFileSync('./config.json'))
const sesid = ses.sesidInsta === "default" ? '45280700401%3AVPWrqxnE4D7S33%3A15' : ses.sesidInsta
const cek = pack.name === "XinzBot" && pack.author === "aqulzz" && pack.repository.url == "git+https://github.com/Xinz-Team/XinzBot.git"
